...
export function elMenuItem(h, menu) {
	...
	else if (menu.icon_d2) icon = <d2-icon-svg name={menu.icon_d2} />;
	else if (menu.icon_el) icon = <i class={`${menu.icon_el}`} />;
...
export function elSubmenu(h, menu) {
	...
	else if (menu.icon_d2) icon = <d2-icon-svg slot="title" name={menu.icon_d2} />;
	else if (menu.icon_el) icon = <i slot="title" class={`${menu.icon_el}`} />;
