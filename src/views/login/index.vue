			...
			<div class="page-login--content" flex="dir:top main:justify cross:stretch box:justify">
				...
				<div class="page-login--content-main" flex="dir:top main:center cross:center">
					...
					<div class="page-login--form">
						...
						<!-- quick login -->
						<el-button class="page-login--quick" size="default" type="info" @click="dialogVisible = true"> 快速选择用户（测试功能） </el-button>
					</div>
				</div>
...
export default {
	...
	data() {
		return {
			...
			// 快速选择用户
			dialogVisible: false,
			users: [{ name: 'Marketing', username: 'marketing', password: 'marketing' }],
			// 表单
			formLogin: { username: 'marketing', password: 'marketing', code: 'v9am' },
			// 表单校验
			rules: {
